...
parser.add_argument("-l", "--level", default=-1, type=int, help="Max depth with the audio files will be searched. With -1 value it will search without depth restrictions. Default value is -1")
parser.add_argument("--uniq_pickle", action="store_true", help="It will create a uniq pickle file for all the audio files. The pickle file will be saved in the path given by -d/--dir")
